...
<form action="${pageContext.request.contextPath.concat('/LogIn')}" method="post">
  ...
  <div class="p-1 m-3 border-0 row form-group">
    ...
    <div class="col-sm-3">
      ...
      <input type="password" id="inputPassword6" name="password" value="${fn:escapeXml(password)}" class="form-control"><br><br>
    </div>
  </div>
  <div class="btn-group">
...
<div class="btn-group dropend">
  ...
  <ul class="dropdown-menu">
    <a class="dropdown-item" href="${pageContext.request.contextPath}/registerUser">Зарегистрироваться</a>
  </ul>
</div>
  </div>
</form>
